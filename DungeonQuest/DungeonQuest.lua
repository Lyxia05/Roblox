...
local function AutoFarming()
    ...
    Tween(Character.HumanoidRootPart, GetTime(_distance, Speed), {CFrame = CURRENT_OBJECT:GetPivot() * CFrame.new(0, CURRENT_OBJECT.HumanoidRootPart.Size.Y + 2, 0) * CFrame.Angles(math.rad(-90), 0, math.rad(90))})

    if _distance <= CURRENT_OBJECT.HumanoidRootPart.Size.Y + 2 then
        ClipEnabled = true
